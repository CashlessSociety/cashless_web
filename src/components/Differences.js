              ...
              <Col sm="12">
                  ...
                  <div className="description text-left">
                    <h5 className="info-title font-weight-bold">Bitcoin, Ethereum or other crypto?</h5>
                     ...
                     <p>Cashless is a bit like "bitcoin meets personal checking". It has no central server, nor even a global blockchain ledger. It is composed of separate hashchains - a network of communities keeping data, and therefore trust and credit, small-world and local.
                      </p>
                      <p>
