      ...
      <div className="features-5">
        ...
        <div>
          <Container>
            <Row>
              <Col md="12">
                <h2 className="title">Gaurantees</h2>
            ...
            <Row>
               <Col md="12">
                  <p className="text-small">
                    We aim to build a type of credit that cares about the communities it's connected to. But credit has to be <b>reliable</b> to be useful. We provide for multiple layers of gaurantee. Three layers of gaurantee at your discretion.
                    </p>
                </Col>
            </Row>
            <Row>
              ...
              <Col>
                <Card>
                  <CardBody>
                    <Row>
                      <Col md="3">
                         <lottie-player src="https://assets4.lottiefiles.com/temp/lf20_DGLtjO.json"  background="transparent"  speed="1" style={{width: "100%", height: "auto"}} hover autoplay loop ></lottie-player>
                         <br />
                           <lottie-player src="https://assets5.lottiefiles.com/packages/lf20_rdsqlthv.json"  background="transparent"  speed="1" style={{width: "100%", height: "auto"}}  loop autoplay></lottie-player>
                      </Col>
                      <Col md="9">
