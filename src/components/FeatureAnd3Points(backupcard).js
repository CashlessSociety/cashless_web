...
function CardAndKeysBak() {
  return (
    <>
      <div className="projects-5 cards_and_keys">
        <Container>
          <Row>
          ...
          <Row>
            ...
            <Col className="mr-auto" md="5">
              ...
              <div className="info info-horizontal">
                ...
                <div className="description">
                  <h4 className="info-title">Bad debt sucks</h4> 
                  <p className="description">
                     Starting a business is risky and hard. If you go out on a limb to create something awesome, you shouldn't get stuck with interest-bearing debt! When you control your sharing networks, you don't have to.
                  </p>
                </div>
              </div>
            </Col>
